...
class ReviewSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        try:
            ...
            None
        try:
            One_star = response.xpath('//p[@class="typography_body-m__xgxZ_ typography_appearance-default__AAY17 styles_cell__qnPHy styles_percentageCell__cHAnb"]/text()[1]').get()
        except:
            None	
