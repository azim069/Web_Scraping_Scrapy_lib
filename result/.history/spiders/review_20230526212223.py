...
class ReviewSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        yield{
            ...
            "Ratings" : response.xpath('//span[@class="typography_body-l__KUYFJ typography_appearance-subtle__8_H2l styles_text__W4hWi"]/text()[1]').get(),
        }   "Scale"   : response.xpath('//span[@class="typography_body-l__KUYFJ typography_appearance-subtle__8_H2l styles_text__W4hWi"]/text()[1]').get()
        return item
